...
<h2 id="useDisableScroll">useDisableScroll</h2>
...
<h2 id="useGetRect">useGetRect</h2>

#### Description

---

Return element DOM rect.
...
- *E extends HTMLElement = any* - assigned to `ref` argument
...
- **ref** -  required. Type `React.MutableRefObject<E | null>`

---

#### Return type `DOMRect | null`
...
const Component: React.FC = () => {
    ...
    const rect = useGetRect<HTMLDivElement>(divRef);
